...
* **Hackathons & Projects:** I love building under pressure with my squad, Team XEROFANG at events like Spark Hack 2026. We developed *Deinfluencer*, an AI-powered browser extension designed to analyze live video and combat online misinformation. The project successfully advanced to the Top 15 out of over 90 competing teams. I have also developed a fully offline, privacy-centric LLM chatbot utilizing Ollama and a FastAPI backend.


* **Game Development:** I pursue game development as a creative extension of my technical skills. I have developed a small 3D FPS game focusing on core mechanics and level design using the Godot engine. Currently, I am applying my Godot and Blender skills to build *Gridlock Gladiator*, an open-world indie game set in New York City that heavily features car driving mechanics.
